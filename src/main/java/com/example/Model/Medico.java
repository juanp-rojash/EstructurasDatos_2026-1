...
public class Medico extends Paciente {
    ...
    private final float porcentajeAvanceInfeccion = 0.2f;
    private final float porcentajeReduccionSalud = 0.3f;

    public Medico(int id, int nivelInfeccion, int nivelSalud, String genoma) {
    ...
    public String cicloMutacion() {
        ...
        String resultado = "Ciclo de Mutación del Médico: \n";
